...
class SequencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sequence" do
    assert_difference('Sequence.count') do
      post sequences_url, params: { sequence: { fecha: @sequence.fecha, secuencia: @sequence.secuencia, user_id: @sequence.user_id } }
    end
  ...
  test "should update sequence" do
    patch sequence_url(@sequence), params: { sequence: { fecha: @sequence.fecha, secuencia: @sequence.secuencia, user_id: @sequence.user_id } }
